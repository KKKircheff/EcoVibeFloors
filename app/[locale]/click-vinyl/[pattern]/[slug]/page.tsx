...
import { getClickVinylProductBySlug, getClickVinylProducts } from '@/utils/products/click-vinyl';
...
// Generate static params for all click-vinyl products
export async function generateStaticParams() {
    const products = getClickVinylProducts();
...
export async function generateMetadata({ params }: ProductDetailPageProps): Promise<Metadata> {
    ...
    const product = getClickVinylProductBySlug(slug);
    ...
    return {
        ...
        alternates: {
            ...
            languages: {
                'bg':        `https://ecovibefloors.com/bg/click-vinyl/${product.pattern}/${product.slug}`,
                'en':        `https://ecovibefloors.com/en/click-vinyl/${product.pattern}/${product.slug}`,
                'x-default': `https://ecovibefloors.com/bg/click-vinyl/${product.pattern}/${product.slug}`,
            },
        },
        openGraph: {
            title: localizedContent.seo.title,
...
export default async function ClickVinylProductPage({ params }: ProductDetailPageProps) {
    ...
    const breadcrumbItems = [
        ...
        { label: patternName, href: `/click-vinyl/${pattern}` },
