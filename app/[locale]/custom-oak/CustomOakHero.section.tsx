...
export async function CustomOakHero() {
    ...
    return (
        ...
        >
            <Image
                ...
                alt="Premium custom oak flooring showcase"
                fill
                priority
                style={{
                    objectFit: 'cover',
            ...
            >
                <HeroTitle>
                    Premium Oak Custom Crafted
                </HeroTitle>
                <HeroSubtitle>
                    Bespoke oak flooring tailored to your unique vision
                </HeroSubtitle>
                <Button
                    variant='text'
                    size="large"
