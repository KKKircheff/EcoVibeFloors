...
export async function HybridWoodStyles() {
    ...
    const classicEvoImages = getStyleCardImages('hy-wood', '1101280228', 2, 0);
    const noblessseEvoImages = getStyleCardImages('hy-wood', '1101280128', 2, 0);
    const herringboneEvoImages = getStyleCardImages('hy-wood', '1101281421', 1, 2);
    const classicOlioImages = getStyleCardImages('hy-wood', '1101280236', 3, 0);
    const noblessseOlioImages = getStyleCardImages('hy-wood', '1101280136', 3, 0);
    const herringboneOlioImages = getStyleCardImages('hy-wood', '1101281428', 0, 2);
