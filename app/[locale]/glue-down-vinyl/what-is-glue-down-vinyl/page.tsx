...
export async function generateMetadata({ params }: WhatIsGlueDownVinylPageProps): Promise<Metadata> {
    const { locale } = await params;
    return { alternates: buildAlternates(locale, '/glue-down-vinyl/what-is-glue-down-vinyl') };
}
