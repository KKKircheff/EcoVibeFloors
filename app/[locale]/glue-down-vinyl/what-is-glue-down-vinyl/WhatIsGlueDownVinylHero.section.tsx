...
export async function WhatIsGlueDownVinylHero() {
    const t = await getTranslations('whatIsGlueDownVinyl.hero');

    return (
        <HeroWrapper id='glue-down-vinyl-hero' minHeight={{ xs: '65vh', md: '40vh' }}>
            <Image
                src={heroImage}
                placeholder="blur"
                alt={t('title')}
