 ...
 *   npx tsx utils/embedding-scripts/generate-embeddings.ts --collection=hybrid-wood
 *   npx tsx utils/embedding-scripts/generate-embeddings.ts --delay=1000
 *   npx tsx utils/embedding-scripts/generate-embeddings.ts --skip-existing
 *   npx tsx utils/embedding-scripts/generate-embeddings.ts --skip-existing --delay=1000
 */
